package com.agentbanking.rules.wire.springdoc.infrastructure.primary;
...
class SpringdocConfiguration {
  ...
  @Bean
  public OpenAPI agentBankingRulesOpenAPI() {
  ...
  @Bean
  public GroupedOpenApi agentBankingRulesAllOpenAPI() {
