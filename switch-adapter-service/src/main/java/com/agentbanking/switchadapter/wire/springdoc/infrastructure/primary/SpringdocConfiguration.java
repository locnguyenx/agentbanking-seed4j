package com.agentbanking.switchadapter.wire.springdoc.infrastructure.primary;
...
class SpringdocConfiguration {
  ...
  @Bean
  public OpenAPI agentBankingSwitchAdapterOpenAPI() {
  ...
  @Bean
  public GroupedOpenApi agentBankingSwitchAdapterAllOpenAPI() {
