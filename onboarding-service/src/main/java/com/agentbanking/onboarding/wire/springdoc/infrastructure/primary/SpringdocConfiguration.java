package com.agentbanking.onboarding.wire.springdoc.infrastructure.primary;
...
class SpringdocConfiguration {
  ...
  @Bean
  public OpenAPI agentBankingOnboardingOpenAPI() {
  ...
  @Bean
  public GroupedOpenApi agentBankingOnboardingAllOpenAPI() {
