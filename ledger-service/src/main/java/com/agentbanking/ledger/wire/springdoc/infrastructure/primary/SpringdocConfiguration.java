package com.agentbanking.ledger.wire.springdoc.infrastructure.primary;
...
class SpringdocConfiguration {
  ...
  @Bean
  public OpenAPI agentBankingLedgerOpenAPI() {
  ...
  @Bean
  public GroupedOpenApi agentBankingLedgerAllOpenAPI() {
