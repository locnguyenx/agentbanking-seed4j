...
@UnitTest
class ApiGatewayCollectionsTest {

  @Nested
  @DisplayName("Collections")
  class ApiGatewayCollectionsCollectionsTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Collection<Object> input = null;
      Collection<Object> collection = ApiGatewayCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Collection<String> collection = ApiGatewayCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Set")
  class ApiGatewayCollectionsSetTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Set<Object> input = null;
      Set<Object> set = ApiGatewayCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Set<String> set = ApiGatewayCollections.immutable(input);
  ...
  @Nested
  @DisplayName("List")
  class ApiGatewayCollectionsListTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      List<Object> input = null;
      List<Object> list = ApiGatewayCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      List<String> list = ApiGatewayCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Map")
  class ApiGatewayMapTest {

    @Test
    void shouldGetEmptyImmutableMapFromNullMap() {
      Map<Object, Object> input = null;
      Map<Object, Object> map = ApiGatewayCollections.immutable(input);
    ...
    void shouldGetImmutableMapFromMutableMap() {
      ...
      input.put("key", "value");
      Map<String, String> map = ApiGatewayCollections.immutable(input);
