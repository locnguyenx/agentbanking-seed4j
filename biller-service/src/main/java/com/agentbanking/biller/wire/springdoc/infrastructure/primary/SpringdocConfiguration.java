package com.agentbanking.biller.wire.springdoc.infrastructure.primary;
...
class SpringdocConfiguration {
  ...
  @Bean
  public OpenAPI agentBankingBillerOpenAPI() {
  ...
  @Bean
  public GroupedOpenApi agentBankingBillerAllOpenAPI() {
