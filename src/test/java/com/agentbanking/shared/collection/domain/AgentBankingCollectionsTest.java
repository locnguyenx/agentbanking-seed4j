package com.agentbanking.shared.collection.domain;
...
@UnitTest
class AgentBankingCollectionsTest {

  @Nested
  @DisplayName("Collections")
  class AgentBankingCollectionsCollectionsTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Collection<Object> input = null;
      Collection<Object> collection = AgentBankingCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Collection<String> collection = AgentBankingCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Set")
  class AgentBankingCollectionsSetTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Set<Object> input = null;
      Set<Object> set = AgentBankingCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Set<String> set = AgentBankingCollections.immutable(input);
  ...
  @Nested
  @DisplayName("List")
  class AgentBankingCollectionsListTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      List<Object> input = null;
      List<Object> list = AgentBankingCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      List<String> list = AgentBankingCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Map")
  class AgentBankingMapTest {

    @Test
    void shouldGetEmptyImmutableMapFromNullMap() {
      Map<Object, Object> input = null;
      Map<Object, Object> map = AgentBankingCollections.immutable(input);
    ...
    void shouldGetImmutableMapFromMutableMap() {
      ...
      input.put("key", "value");
      Map<String, String> map = AgentBankingCollections.immutable(input);
