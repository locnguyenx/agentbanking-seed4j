...
@UnitTest
class TestMicroserviceCollectionsTest {

  @Nested
  @DisplayName("Collections")
  class TestMicroserviceCollectionsCollectionsTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Collection<Object> input = null;
      Collection<Object> collection = TestMicroserviceCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Collection<String> collection = TestMicroserviceCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Set")
  class TestMicroserviceCollectionsSetTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Set<Object> input = null;
      Set<Object> set = TestMicroserviceCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Set<String> set = TestMicroserviceCollections.immutable(input);
  ...
  @Nested
  @DisplayName("List")
  class TestMicroserviceCollectionsListTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      List<Object> input = null;
      List<Object> list = TestMicroserviceCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      List<String> list = TestMicroserviceCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Map")
  class TestMicroserviceMapTest {

    @Test
    void shouldGetEmptyImmutableMapFromNullMap() {
      Map<Object, Object> input = null;
      Map<Object, Object> map = TestMicroserviceCollections.immutable(input);
    ...
    void shouldGetImmutableMapFromMutableMap() {
      ...
      input.put("key", "value");
      Map<String, String> map = TestMicroserviceCollections.immutable(input);
