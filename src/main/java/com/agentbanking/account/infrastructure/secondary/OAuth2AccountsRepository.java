package com.agentbanking.account.infrastructure.secondary;

import com.agentbanking.account.domain.Account;
import com.agentbanking.account.domain.AccountsRepository;
